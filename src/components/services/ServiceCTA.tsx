...
import { FaPaperPlane, FaCalendarCheck, FaPhoneAlt, FaEnvelope } from "react-icons/fa";
        ...
        <div className="bg-brand-900/80 backdrop-blur-xl p-8 sm:p-12 lg:p-16 rounded-3xl border border-brand-800 shadow-2xl flex flex-col lg:flex-row lg:items-center justify-between gap-10">
          ...
          <div className="max-w-2xl flex flex-col gap-4">
            ...
            <h2 className="font-heading text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white tracking-tight leading-tight">
              Request a Custom Proposal for <span className="text-accent">{service.code} Engineering</span>
            </h2>

            <p className="text-slate-300 text-base sm:text-lg leading-relaxed">
              Consult with our senior MEP engineers for heat load calculations, BNBC safety compliance audits, and custom system pricing.
            </p>

            <div className="pt-2 flex flex-wrap items-center gap-6 text-xs text-slate-400">
              <div className="flex items-center gap-2">
                <FaPhoneAlt className="text-accent" />
                <span>Direct Hotline: +880 1700-000000</span>
              </div>
              <div className="flex items-center gap-2">
          ...
          <div className="flex flex-col sm:flex-row lg:flex-col xl:flex-row gap-4 shrink-0">
            <Link
              href={`/contact?service=${service.slug}&type=quotation`}
            ...
            <Link
              href={`/contact?service=${service.slug}&type=consultation`}
            ...
            >
              <FaCalendarCheck className="text-accent text-sm" />
